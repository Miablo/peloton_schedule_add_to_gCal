...
def _peloton_session(s):
    ...
    -------
    dict
        user id, session id, parameter id
...
def _get_reservations(session, usr_id, headers):
	...
	## additional items to retrieve and store in this api call
 #  "scheduled_start_time": 1585305000,
 #  "start_time": 1585305000,
 #  "end_time": 1585306084,
 #  "pedaling_start_time": 1585
...
def calendar_api_call(event_response_body):
    """
...
def main():
	...
	usr_dict = _peloton_session(s)

	usr_id = usr_dict['user_id']
	headers = {
        "Content-Type": "application/json",
    }
